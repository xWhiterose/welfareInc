...
export default function HeroSection() {
  ...
  return (
    <div className="flex-1 flex flex-col justify-center items-center text-center px-6 pb-24">
      <div className="mb-6">
        <Badge 
          variant="secondary" 
          className="bg-purple-500 bg-opacity-20 border border-purple-400 text-purple-300 mb-8 px-4 py-2"
        >
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-16">
        ...
        <Button 
          ...
          className="border-gray-400 hover:border-white text-gray-300 hover:text-white px-8 py-4 text-lg font-semibold"
        >
          📖 Read the docs
        </Button>
      </div>
